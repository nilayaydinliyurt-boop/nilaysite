...
<head>
    ...
    <style>
        ...
        .btn { border: 1px solid var(--accent); color: var(--accent); padding: 12px 30px; text-decoration: none; font-weight: bold; margin-top: 30px; display: inline-block; transition: 0.3s; }
...
<section class="hero">
    ...
    <a href="#works" class="btn">DISCOVER MORE</a>
</section>
...
<section id="works" class="section">
    ...
    <div class="grid">
        <div class="card">
            ...
            <h3>Digital Releases</h3>
            <p>"Vay Anasını Vay", "Deli Deli", "Adaçayı" and more. Available on Spotify, Apple Music & Deezer.</p>
            <a href="https://open.spotify.com/artist/YOUR_LINK_HERE" target="_blank" class="btn" style="padding: 8px 15px;">Listen Now</a>
        </div>
        <div class="card">
            <i class="fab fa-youtube"></i>
            <h3>YouTube Presence</h3>
            <p>Strategic music management and creative content on @melora.x and @Djmuziktr channels.</p>
            <a href="https://youtube.com/@melora.x" target="_blank" class="btn" style="padding: 8px 15px;">View Channels</a>
        </div>
    </div>
</section>
...
<footer>
    <p>&copy; 2026 Nilay Aydınlıyurt. All Rights Reserved. / Tüm Hakları Saklıdır.</p>
</footer>
